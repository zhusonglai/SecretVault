...
#[derive(Debug)]
pub struct SecretVaultProcessor {
    verbose: bool,
    processed_count: usize,
}

impl SecretVaultProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    let mut processor = SecretVaultProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = SecretVaultProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = SecretVaultProcessor::new(false);
